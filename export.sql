...
-- Listage des données de la table the_district.categorie : ~9 rows (environ)
...
-- Listage des données de la table the_district.commande : ~3 rows (environ)
...
-- Listage des données de la table the_district.plat : ~11 rows (environ)
INSERT INTO `plat` (`id`, `libelle`, `description`, `prix`, `image`, `id_categorie`, `active`) VALUES
	...
	(5, 'Pizza Bianca', 'Une pizza fine et croustillante garnie de crème mascarpone légèrement citronnée et de tranches de saumon fumé, le tout relevé de baies roses et de basilic frais.', 16.94, 'pizza-salmon.png', 4, 'Yes'),
	...
	(14, 'Pizza Margherita', 'Une authentique pizza margarita, un classique de la cuisine italienne! Une pâte faite maison, une sauce tomate fraîche, de la mozzarella Fior di latte, du basilic, origan, ail, sucre, sel & poivre...', 16.94, 'pizza-margherita.jpg', 4, 'Yes'),
	...
	(17, 'Tagliatelles au saumon', 'Découvrez notre recette délicieuse de tagliatelles au saumon frais et à la crème qui qui vous assure un véritable régal!', 12.00, 'pate_saumon.jpg', 10, 'Yes'),
	(18, 'Chedar Burger', 'Burger composé de chedar.', 9.00, 'hamburger_chedar.jpg', 15, 'Yes');
