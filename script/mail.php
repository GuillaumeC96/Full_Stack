...
function envoi_mail_commande($nom)
{
    ...
    // Corps du message
    $mail->Body = "Bonjour " . $nom . ", votre commande sera livrée !";
    ...
    if ($mail) {
        try {
            ...
            $result = "L'envoi de mail a échoué. L'erreur suivante s'est produite : " . $mail->ErrorInfo;
        }
    }
